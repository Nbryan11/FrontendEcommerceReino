              ...
              (
                <div className='flex flex-col items-center lg:items-start gap-1'>
                  ...
                  <div className='flex items-center gap-3 my-2'>                 
                    <Link to={data.link} target="_blank" className='border-2 border-blue-600 rounded px-3 py-1 min-w-[120px] text-blue-600 font-medium hover:bg-blue-600 hover:text-white'>
 Buy
</Link>
